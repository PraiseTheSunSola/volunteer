document.addEventListener("DOMContentLoaded", () => {
    ...
    const allCards = document.querySelectorAll(".signCardList-item, .joinCardList-item, .lastCardList-item"); // 검색할 모든 카드 요소들
    ...
    function searchCards() {
        ...
        allCards.forEach(card => {
            const title = card.querySelector(".signCard-title, .joinCard-title, .lastCard-title").textContent.toLowerCase();
